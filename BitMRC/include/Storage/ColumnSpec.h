...
enum { CS_TYPE_NONE = 0, CS_TYPE_INT16, CS_TYPE_INT32, CS_TYPE_INT64, CS_TYPE_UINT16,
	CS_TYPE_UINT32, CS_TYPE_UINT64, CS_TYPE_STRING, CS_TYPE_FLOAT, CS_TYPE_TEXT, CS_TYPE_BLOB, CS_TYPE_MAX } enColumnType;
